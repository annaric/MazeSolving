...
batch_size=4,
 exploration_final_eps=0.1, learning_rate=0.001, gamma=0.8, exploration_initial_eps=1, exploration_fraction=0.1, tensorboard_log='./tb_logs/', learning_starts=5000)
