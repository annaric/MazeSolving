...
#model = DQN("MlpPolicy", env, verbose=1, exploration_final_eps=0.05,  gamma = 0.9, learning_rate=0.01, exploration_initial_eps=1, exploration_fraction=0.2, tensorboard_log='./tb_logs/', learning_starts=10000)
